        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <a href="{{ route('admin.produksi_bahan.create') }}" class="btn btn-info d-flex align-items-center">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.produksi_bahan.report') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                        ...
                        <tbody>
                            @foreach ($datas as $result)
                                <tr>
                                    ...
                                    <td>{{ $result->bahan->name }}</td>
                                    <td>{{ $result->jumlah_produksi }}</td>
                                    <td>{{ $result->bahan->satuan }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="card-body">
                <div class="alert alert-warning mb-0" role="alert">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <p class="mb-0">
                            No Bahan Baku data yet. <a href="{{ route('admin.' . $active . '.create') }}">Add</a> now.
                        </p>
                    </div>
                </div>
            </div>
